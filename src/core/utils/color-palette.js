...
var ColorPalette = /** @class */ (function () {
    ...
    ColorPalette.colors = function () {
        var colors = [];
        for (var _i = 0, _a = Object.values(BREWERS); _i < _a.length; _i++) {
            var brewer = _a[_i];
            for (var _b = 0, brewer_1 = brewer; _b < brewer_1.length; _b++) {
                var color = brewer_1[_b];
                colors.push(color_1.Color.fromNumber(color));
            }
        }
